export const metadata = {
  "title": "Jev AI GitHub Guide: Gist, Official Docs, and Setup",
  "description": "Use this Jev AI GitHub guide to distinguish the community project reference from official TypeSafe docs, inspect model details, and plan safe integration.",
  "category": "typesafe",
  "date": "2026-09-20",
  "status": "draft"
};
