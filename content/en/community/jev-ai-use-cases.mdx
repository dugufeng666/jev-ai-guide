export const metadata = {
  "title": "Jev AI Use Cases: A Practical Agent Decision Guide",
  "description": "Explore jev ai use cases for model routing, tool-call checks, and support triage, with a source-grounded workflow, decision types, and practical limits.",
  "category": "community",
  "date": "2026-09-20",
  "status": "draft"
};
